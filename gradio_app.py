        ...
        with gr.Row():
            with gr.Column(scale=1., variant='panel'):
                ...
                with gr.Tab("Text to 3D"):
                    ...
                    word_input = gr.Textbox(label="Keyword for initialization", value="bed", interactive=True)
                    ...
                    with gr.Accordion("Advanced Options", open=False):
                        opt_step = gr.Slider(0, 1000, value=1, step=1, label='Number of text embedding optimization step')
                        pivot_step = gr.Slider(0, 1000, value=1, step=1, label='Number of pivotal tuning step for LoRA')
                    with gr.Row():
                ...
                with gr.Tab("Image to 3D"):
                    ...
                    word_input_2 = gr.Textbox(label="Keyword for initialization", value="dog", interactive=True)
                    ...
                    with gr.Accordion("Advanced Options", open=False):
                        opt_step_2 = gr.Slider(0, 1000, value=1, step=1, label='Number of text embedding optimization step')
                        pivot_step_2 = gr.Slider(0, 1000, value=1, step=1, label='Number of pivotal tuning step for LoRA')
                    with gr.Row():
